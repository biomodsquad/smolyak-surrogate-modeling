...
class IndexGrid:
    ...
    For instance: Consider n = 2, :math:\mu = 1 and Chebyshev's polynomial
    of first kind as the basis fucntion:
    ..math:
        ``level_indexes`` = [[0], [1,2]]
        ``level_composition_index`` = [([0],[0]), ([0],[1,2]), ([1,2],[0])]
    then:
    ..math:
    ...
    def _update(self):
        ...
        self._grid_point_indexes = self._grid_point_indexes.tolist()
